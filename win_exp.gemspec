...
Gem::Specification.new do |gem|
  gem.name        = "win_exp"
  gem.version     = ::WinExp::VERSION
  gem.summary     = %q{This is just a sandbox for experiments}
  gem.description = %q{This is just a sandbox for experiments}
  gem.authors     = ["arvicco"]
  gem.email       = "arvitallian@gmail.com"
  gem.homepage    = %q{http://github.com/arvicco/win_exp}
  ...
  # RDoc setup
  gem.has_rdoc = true
  gem.rdoc_options.concat %W{--charset UTF-8 --main README.rdoc --title win_exp}
